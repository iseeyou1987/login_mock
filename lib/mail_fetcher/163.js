...
Fetcher.prototype.getList = function*(start,limit){
  ...
  var list_url = 'http://mail.163.com/js6/s?sid='+sid+'&func=mbox:listMessages&LeftNavfolder1Click=1&mbox_folder_enter=1';
  var xml_data = [
              { object: [
  ...
  while(true){
    ...
    if(item_list){
      ...
      for(let i of item_list){
        ...
        var read_url = 'http://mail.163.com/js6/read/readhtml.jsp';
        var read_params = {
          'mid':i['id'],
          'font':'15',
          'color':'1D6CA3'
