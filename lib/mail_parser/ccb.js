...
module.exports.execute = function (str) {
  ...
  var result = {};
  var parts = str.match(/<table width="875" cellPadding='0' cellSpacing='0'>(.+?)<\/table>|<table width="875" cellpadding="0" cellspacing="0">(.+?)<\/table>/g);

  var info = str.replace(/\r|\n/g,' ').replace(/\r\n/g,' ').match(/<table border='1' cellpadding="0" cellspacing="0" width='100%'>(.+?)<\/table>|<table border="1" cellpadding="0" cellspacing="0" width="100%">(.+?)<\/table>/g);
